...
if DATABASE_URL:
    # Если DATABASE_URL установлен, используем его
    DATABASES = {
    ...
    # Fallback: прямая конфигурация PostgreSQL
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME', 'mineral_licenses_db'),
            'USER': os.getenv('DB_USER', 'mineral_user'),
